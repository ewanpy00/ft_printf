...
/*   Updated: 2025/11/26 21:54:12 by ivan             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	handle_percent(const char *format, size_t *i, va_list *args,
		t_count *count)
{
	ssize_t	check_d;
...
static int	process_next(const char *format, size_t *i, va_list *args,
		t_count *count)
{
	ssize_t	check_d;
